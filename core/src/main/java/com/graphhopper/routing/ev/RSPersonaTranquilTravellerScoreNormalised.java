...
public class RSPersonaTranquilTravellerScoreNormalised {
    public static final String KEY = "persona_tranquiltraveller_score_normalised";

    public static DecimalEncodedValue create() {
        // Range: 0.0 to 1.0 (normalized persona score)
